...
void TorqueGeneratedClassVerifiers::JSNumberFormatVerify(JSNumberFormat o, Isolate* isolate) {
  ...
  {
    Object icu_number_range_formatter__value = TaggedField<Object>::load(o, 40);
    Object::VerifyPointer(isolate, icu_number_range_formatter__value);
    CHECK(icu_number_range_formatter__value.IsForeign());
  }
  {
    Object bound_format__value = TaggedField<Object>::load(o, 48);
    Object::VerifyPointer(isolate, bound_format__value);
    CHECK(bound_format__value.IsUndefined() || bound_format__value.IsJSFunction());
  }
}
void TorqueGeneratedClassVerifiers::JSPluralRulesVerify(JSPluralRules o, Isolate* isolate) {
  ...
  {
    Object icu_number_range_formatter__value = TaggedField<Object>::load(o, 56);
    Object::VerifyPointer(isolate, icu_number_range_formatter__value);
    CHECK(icu_number_range_formatter__value.IsForeign());
  }
}
